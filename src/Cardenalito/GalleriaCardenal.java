 ...
 * @author Shary
 */
public class GalleriaCardenal extends javax.swing.JFrame {
    ...
    public void cargarBat(){
        ballenas[0]=(new ImageIcon(getClass().getResource("/AnimalesImages/Cardenal/cardenal1.jpg"))).getImage();
        ballenas[1]=(new ImageIcon(getClass().getResource("/AnimalesImages/Cardenal/cardenal2.jpg"))).getImage();
        ballenas[2]=(new ImageIcon(getClass().getResource("/AnimalesImages/Cardenal/cardenal3.jpg"))).getImage();
        ballenas[3]=(new ImageIcon(getClass().getResource("/AnimalesImages/Cardenal/cardenal4.JPG"))).getImage();
        ballenas[4]=(new ImageIcon(getClass().getResource("/Recursos/ButtonsGallery.png"))).getImage();
    ...
    public void dibujar(int i, int j){
        ...
        try{
            ...
            k.drawImage(ballenas[j], 0, 300, null);
        }catch(Exception ex){
    ...
    private void jPanel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel1MouseClicked
        ...
        if(evt.getY()>23 && evt.getY()<63 && evt.getX()>23 && evt.getX()<63){
            ...
            InfoCardenal m=new InfoCardenal();
            m.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GalleriaCardenal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GalleriaCardenal().setVisible(true);
            }
        });
    }
