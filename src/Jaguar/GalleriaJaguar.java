 ...
 * @author Shary
 */
public class GalleriaJaguar extends javax.swing.JFrame {
    ...
    public void cargarBat(){
        ballenas[0]=(new ImageIcon(getClass().getResource("/AnimalesImages/Jaguar/jaguar1.jpeg"))).getImage();
        ballenas[1]=(new ImageIcon(getClass().getResource("/AnimalesImages/Jaguar/jaguar2.jpg"))).getImage();
        ballenas[2]=(new ImageIcon(getClass().getResource("/AnimalesImages/Jaguar/jaguar3.jpg"))).getImage();
        ballenas[3]=(new ImageIcon(getClass().getResource("/AnimalesImages/Jaguar/jaguar4.jpg"))).getImage();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GalleriaJaguar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GalleriaJaguar().setVisible(true);
            }
        });
    }
